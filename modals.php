            ...
            <div class="modal-body">
                ...
                <form id="formNovoProduto" action="criar_produto.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="eanProduto" name="ean">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fabricanteProduto" name="fabricante">
                    </div>
                    <div class="form-group">
                        <label for="franquiaProduto">Franquia</label>
                        <input type="text" class="form-control" id="franquiaProduto" name="franquia">
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="finalizeModal" tabindex="-1" role="dialog" aria-labelledby="finalizeModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="finalizeModalLabel">Finalizar Compra</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        <label for="purchaseId">ID da Compra</label>
                        <input type="text" class="form-control" id="purchaseId" disabled>
                    </div>
                    <div class="form-group">
