    ...
    <script>
        $(document).ready(function () {
            ...
            $('#search-results').on('click', '.list-group-item', function () {
                ...
                $('#product-table tbody').append('<tr><td>' + productId + '</td><td>' + productDescription + '</td><td>' + productQuantity + '</td><td>' + productEan + '</td><td>' + productTotal + '</td><td align="center"><a href="javascript:void(0)" class="text-inverse" title=""><i class="ti-trash text-dark"></i></a></td></tr>');
            ...
            // Adicione este evento para lidar com a exclusão de linhas da tabela
            $('#product-table tbody').on('click', '.ti-trash', function () {
            ...
            function loadTableData() {
                ...
                if (tableData) {
                    tableData.forEach(function (item) {
                        $('#product-table tbody').append('<tr><td>' + item.id + '</td><td>' + item.description + '</td><td>' + item.quantity + '</td><td>' + item.ean + '</td><td>' + item.total + '</td><td align="center"><a href="javascript:void(0)" class="text-inverse" title=""><i class="ti-trash text-dark"></i></a></td></tr>');
                    });
                    updateTotal();
                }
            }
